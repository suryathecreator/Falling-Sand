...
// Abstract base class for gas particles
public abstract class FlammableGasParticle extends Particle {
  public FlammableGasParticle(){}
    
  public FlammableGasParticle(Grid grid, int x, int y){
    super(grid, x, y);      
  }  
